...
class Someclass {
    static var name: String = "baem"
    var age = 10
    
    static func nameChange(newName: String) {
        name = newName
    }
}


var people1 = Someclass()
var people2 = Someclass()
var people3 = Someclass()
print(people1)
Someclass.nameChange(newName: "baem2222")
